    ...
    pub mod asterbot {
        pub mod types {
            ...
            pub mod skills {
                ...
                #[doc(hidden)]
                macro_rules! __export_asterbot_types_skills_1_0_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "asterbot:types/skills@1.0.0#list-all"] unsafe extern "C" fn
                        export_list_all() -> * mut u8 { $($path_to_types)*::
                        _export_list_all_cabi::<$ty > () } #[export_name =
                        "cabi_post_asterbot:types/skills@1.0.0#list-all"] unsafe extern
                        "C" fn _post_return_list_all(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_list_all::<$ty > (arg0) }
                        #[export_name = "asterbot:types/skills@1.0.0#get"] unsafe extern
                        "C" fn export_get(arg0 : * mut u8, arg1 : usize,) -> * mut u8 {
                        $($path_to_types)*:: _export_get_cabi::<$ty > (arg0, arg1) }
                        #[export_name = "cabi_post_asterbot:types/skills@1.0.0#get"]
                        unsafe extern "C" fn _post_return_get(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_get::<$ty > (arg0) }
                        #[export_name = "asterbot:types/skills@1.0.0#set"] unsafe extern
                        ...
                        "asterbot:types/skills@1.0.0#remove"] unsafe extern "C" fn
                ...
                #[doc(hidden)]
                pub(crate) use __export_asterbot_types_skills_1_0_0_cabi;
                #[repr(align(4))]
...
macro_rules! __export_component_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::asterbot::types::skills::__export_asterbot_types_skills_1_0_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::asterbot::types::skills);
    };
}
#[doc(inline)]
pub(crate) use __export_component_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:asterbot:skills@1.0.0:component:encoded world"]
#[doc(hidden)]
...
t:types/skills@1.0.0\x05\x01\x04\0\x1fasterbot:skills/component@1.0.0\x04\0\x0b\x0f\
