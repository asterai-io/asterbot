    ...
    pub mod asterbot {
        pub mod types {
            ...
            pub mod soul {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_set_cabi<T: Guest>(arg0: *mut u8, arg1: usize) {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    let len0 = arg1;
                    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
                    T::set(_rt::string_lift(bytes0));
                }
                pub trait Guest {
                    fn get() -> _rt::String;
                    fn set(content: _rt::String);
                }
                #[doc(hidden)]
                macro_rules! __export_asterbot_types_soul_1_0_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name = "asterbot:types/soul@1.0.0#get"]
                        unsafe extern "C" fn export_get() -> * mut u8 {
                        $($path_to_types)*:: _export_get_cabi::<$ty > () } #[export_name
                        = "cabi_post_asterbot:types/soul@1.0.0#get"] unsafe extern "C" fn
                        _post_return_get(arg0 : * mut u8,) { $($path_to_types)*::
                        __post_return_get::<$ty > (arg0) } #[export_name =
                        "asterbot:types/soul@1.0.0#set"] unsafe extern "C" fn
                        export_set(arg0 : * mut u8, arg1 : usize,) { $($path_to_types)*::
                        _export_set_cabi::<$ty > (arg0, arg1) } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_asterbot_types_soul_1_0_0_cabi;
                #[repr(align(4))]
...
macro_rules! __export_component_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::asterbot::types::soul::__export_asterbot_types_soul_1_0_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::asterbot::types::soul);
    };
}
#[doc(inline)]
pub(crate) use __export_component_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:asterbot:soul@1.0.0:component:encoded world"]
#[doc(hidden)]
...
sterai:host/api@1.0.0\x05\0\x01B\x04\x01@\0\0s\x04\0\x03get\x01\0\x01@\x01\x07co\
ntents\x01\0\x04\0\x03set\x01\x01\x04\0\x19asterbot:types/soul@1.0.0\x05\x01\x04\
\0\x1dasterbot:soul/component@1.0.0\x04\0\x0b\x0f\x01\0\x09component\x03\0\0\0G\x09\
