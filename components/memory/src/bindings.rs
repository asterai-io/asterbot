    ...
    pub mod asterbot {
        pub mod types {
            ...
            pub mod memory {
                ...
                pub unsafe fn _export_list_all_cabi<T: Guest>() -> *mut u8 {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    let result0 = T::list_all();
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_list_all<T: Guest>(arg0: *mut u8) {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_remove_cabi<T: Guest>(arg0: *mut u8, arg1: usize) {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    let len0 = arg1;
                    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
                    T::remove(_rt::string_lift(bytes0));
                }
                pub trait Guest {
                    fn list_all() -> _rt::Vec<_rt::String>;
                    fn get(name: _rt::String) -> _rt::String;
                    fn set(name: _rt::String, content: _rt::String);
                    fn remove(name: _rt::String);
                }
                #[doc(hidden)]
                macro_rules! __export_asterbot_types_memory_1_0_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "asterbot:types/memory@1.0.0#list-all"] unsafe extern "C" fn
                        export_list_all() -> * mut u8 { $($path_to_types)*::
                        _export_list_all_cabi::<$ty > () } #[export_name =
                        "cabi_post_asterbot:types/memory@1.0.0#list-all"] unsafe extern
                        "C" fn _post_return_list_all(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_list_all::<$ty > (arg0) }
                        #[export_name = "asterbot:types/memory@1.0.0#get"] unsafe extern
                        "C" fn export_get(arg0 : * mut u8, arg1 : usize,) -> * mut u8 {
                        $($path_to_types)*:: _export_get_cabi::<$ty > (arg0, arg1) }
                        #[export_name = "cabi_post_asterbot:types/memory@1.0.0#get"]
                        unsafe extern "C" fn _post_return_get(arg0 : * mut u8,) {
                        $($path_to_types)*:: __post_return_get::<$ty > (arg0) }
                        #[export_name = "asterbot:types/memory@1.0.0#set"] unsafe extern
                        "C" fn export_set(arg0 : * mut u8, arg1 : usize, arg2 : * mut u8,
                        arg3 : usize,) { $($path_to_types)*:: _export_set_cabi::<$ty >
                        (arg0, arg1, arg2, arg3) } #[export_name =
                        "asterbot:types/memory@1.0.0#remove"] unsafe extern "C" fn
                        export_remove(arg0 : * mut u8, arg1 : usize,) {
                        $($path_to_types)*:: _export_remove_cabi::<$ty > (arg0, arg1) }
                        };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_asterbot_types_memory_1_0_0_cabi;
                #[repr(align(4))]
...
macro_rules! __export_component_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::asterbot::types::memory::__export_asterbot_types_memory_1_0_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::asterbot::types::memory);
    };
}
#[doc(inline)]
pub(crate) use __export_component_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:asterbot:memory@1.0.0:component:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1012] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xf4\x06\x01A\x02\x01\
...
sterai:host/api@1.0.0\x05\0\x01B\x09\x01ps\x01@\0\0\0\x04\0\x08list-all\x01\x01\x01\
@\x01\x04names\0s\x04\0\x03get\x01\x02\x01@\x02\x04names\x07contents\x01\0\x04\0\
\x03set\x01\x03\x01@\x01\x04names\x01\0\x04\0\x06remove\x01\x04\x04\0\x1basterbo\
t:types/memory@1.0.0\x05\x01\x04\0\x1fasterbot:memory/component@1.0.0\x04\0\x0b\x0f\
