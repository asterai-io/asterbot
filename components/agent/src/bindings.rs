    ...
    pub mod asterbot {
        pub mod agent {
            ...
            pub mod agent {
                ...
                pub unsafe fn _export_converse_cabi<T: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                ) -> *mut u8 {
                    ...
                    let result1 = T::converse(_rt::string_lift(bytes0));
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_converse<T: Guest>(arg0: *mut u8) {
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:asterbot:agent@1.0.0:component:encoded world"]
#[doc(hidden)]
